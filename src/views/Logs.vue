<template>
  <div
    ...
    :class="{ 'is-floating-entry': isFloatingLogsEntry }"
  >
    <Teleport to="body">
      <div
        v-if="isFloatingLogsEntry"
        class="logs-floating-entry-backdrop"
      />
      <div
...
const isFloatingLogsEntry = computed(
  () => route.path === LOGS_PATH && Boolean(getFloatingLogsPreviousRoute()),
);
