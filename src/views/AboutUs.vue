<template>
  <div class="page-wrapper">
    <div class="about-wrapper">
      ...
      <div class="block-content">
        <nut-cell-group :title="$t(`aboutUsPage.projectInfo.title`)">
          ...
          <nut-cell class="cell-item" :desc="$t(`aboutUsPage.projectInfo.link`)"
            url="https://github.com/sub-store-org/Sub-Store-Front-End">
            <template v-slot:title>
              <span>{{ $t(`aboutUsPage.projectInfo.fe`) }}
          ...
          <nut-cell class="cell-item" :desc="$t(`aboutUsPage.projectInfo.link`)"
            ...
            <template v-slot:title>
              <span>{{ $t(`aboutUsPage.projectInfo.be`) }}
          ...
          <nut-cell class="cell-item" :desc="$t(`aboutUsPage.projectInfo.link`)" url="https://github.com/sub-store-org">
            <template v-slot:title>
    ...
    <div class="changelog-wrapper">
      ...
      <div class="block-content">
        <nut-collapse v-model:active="active" icon="rect-right" rotate="90" accordion>
          <nut-collapse-item v-for="changelog in changelogs" :key="changelog.htmlContent"
